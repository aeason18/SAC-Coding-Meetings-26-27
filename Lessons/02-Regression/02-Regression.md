...
## Today's Model
The model you will be making today uses NFL passing data from 2016 to 2025. At the end, you will be able to predict the passing stats for the 2026 season and have a good understanding of what linear regression is used for. <br>
